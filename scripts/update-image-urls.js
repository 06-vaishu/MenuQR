...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ynmehlyscvrbsrwuinpn.supabase.co';
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlubWVobHlzY3ZyYnNyd3VpbnBuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NjgwMjgyNywiZXhwIjoyMDYyMzc4ODI3fQ.DUPqBb5BlXCk7JT5VAepMgQawRC0BF0-1uco9R_KZdA';
  ...
  for (const menu of menus) {
    if (menu.background_image_url && menu.background_image_url.includes('localhost')) {
      const newUrl = menu.background_image_url.replace(
        ...
        'https://ynmehlyscvrbsrwuinpn.supabase.co'
      );
